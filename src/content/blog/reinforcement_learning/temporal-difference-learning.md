...
tags: ["reinforcement-learning", "TD-learning"]
---
...
$$ V(S*t) \gets V(S_t) + \alpha [R*{t+1} + \gamma V(S\_{t+1}) - V(S_t)] $$
...
$$ \delta*t \doteq R*{t+1} + \gamma V(S\_{t+1}) - V(S_t) $$
...
$$ Q(S*t, A_t) \gets Q(S_t, A_t) + \alpha[R*{t+1} + \gamma Q(S*{t+1}, A*{t+1}) - Q(S_t,A_t)]$$
...
$$ Q(S*t, A_t) \gets Q(S_t, A_t) + \alpha[R*{t+1} + \gamma \max*aQ(S*{t+1}, a) - Q(S_t,A_t)]$$
...
$$ Q*1(S_t, A_t) \gets Q_1(S_t, A_t) + \alpha[R*{t+1} + \gamma Q*2(S*{t+1},\argmax*aQ_1(S*{t+1}, a)) - Q_1(S_t,A_t)]$$
